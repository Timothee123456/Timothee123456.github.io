...
class FlipDown {
  ...
  _createRotorGroup(rotors, rotorIndex) {
    ...
    // Add a specific class based on rotorIndex
  switch (rotorIndex) {
    case 0:
      rotorGroup.classList.add('rotor-group-days');
      break;
    case 1:
      rotorGroup.classList.add('rotor-group-hours');
      break;
    case 2:
      rotorGroup.classList.add('rotor-group-minutes');
      break;
    case 3:
